...
{ 
  ...
  public EmailSendRequest CreateWelcomeEmail(string recipient)
  { 
      ...
      $@"
        ...
        <body style='margin:0; padding:32px; font-family: -apple-system, BlinkMacSystemFont, ""Segoe UI"", Roboto, sans-serif; background-color:#FFFFFF; color:#000000; line-height:1.5;'>
          <div style='max-width:600px; margin:0 auto; background:#FFFFFF; padding:40px;'>
            ...
            <div style='text-align:center; margin:32px 0;'>
              <a href='{resetUrl}' style='display:inline-block; background-color:#4F46E5; color:#FFFFFF; padding:12px 32px; border-radius:8px; text-decoration:none; font-weight:600; font-size:16px;'>Reset Password</a>
            </div>
  ...
  public EmailSendRequest CreateAccountDeletedEmail(string recipient)
  {
